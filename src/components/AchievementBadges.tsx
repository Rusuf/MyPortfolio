...
const achievements = [
  {
    ...
    date: "February 2025",
    description: "Built and shipped a working solution under competition time pressure",
    icon: "🏆",
    color: "#FF69B4"
  },
  {
    id: 2,
    name: "Founded NiTip Africa",
    date: "2025",
    description: "Live M-Pesa tipping platform in active beta at nitip.africa",
    icon: "🌍",
    color: "#4CAF50"
  },
  {
    ...
    date: "January 2025",
    description: "Consistently delivering quality software projects",
    icon: "🚀",
    color: "#1E90FF"
  },
  {
        ...
        {achievements.map((achievement) => (
          ...
          >
            <div className="achievement-badge bg-cosmic-nebula bg-opacity-20 backdrop-blur-md rounded-lg p-6 border border-cosmic-neon flex flex-col items-center text-center transition-all duration-500 hover:transform hover:scale-105">
              ...
              <h4 className="text-cosmic-electric font-orbitron text-sm mb-1">
                {achievement.name}
              </h4>
